...
//PermissionAPI holds the endpoint of the dapp api
var PermissionAPI string
...
func IsNodePermissioned(nodename string, currentNode string, permissionapi string, direction string) bool {
	return(isNodePermissioned(nodename, currentNode,  permissionapi, direction))
}
...
func isNodePermissioned(nodename string, currentNode string,  permissionapi string, direction string) bool {
	...
	fmt.Println("api endpoint is ")
	fmt.Println(PermissionAPI)
