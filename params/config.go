...
var (
	...
	CobunaGenesisHash = common.HexToHash("0x5c1363399a5f5a3f1a201c4e8de20533bc82f9d11dcda4b1be82d47cca3a3e66") // Cobuna genesis hash to enforce below configs on
)
...
var (
	...
	// CobunaChainConfig contains the chain parameters to run a node on the Cobuna network.
	CobunaChainConfig = &ChainConfig{
		ChainId:        big.NewInt(1472583695),
		HomesteadBlock: big.NewInt(1),
		DAOForkBlock:   nil,
		DAOForkSupport: true,
		EIP150Block:    big.NewInt(0),
